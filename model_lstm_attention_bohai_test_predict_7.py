...
f = open('results_bohai_test_compare_7.txt', 'a')
save_folder = 'saved_model_bohai_test_compare_7'
...
for filename in filenames:
    ...
    # scaler = MinMaxScaler(feature_range=(0, 1))[:, 1:14, 1:14]
