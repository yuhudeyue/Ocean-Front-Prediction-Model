...
def vae_loss(y_true, y_pred):
    #xent_loss = tf.square(y_true[:, :, :, 0:OUTPUTDIM] - y_pred[:, :, :, 0:OUTPUTDIM]/ (y_true[:, :, :, 0:OUTPUTDIM] + y_pred[:, :, :, 0:OUTPUTDIM]))
...
f = open('results_kuroshio_test_compare_3.txt', 'a')
save_folder = 'saved_model_kuroshio_test_compare_3'
...
for filename in filenames:
    ...
    inv_yhat = y_hat[7:957, :, :, :, 0]
    inv_testY = evaluate_Y[0:950, :, :, :, 0]
