...
def train_model(train_X, train_Y, Epochs, Batch_size, save_folder):
    ...
    # this is attention part x_1, x_1, x_2, x_4 ,x_5  sigmoid
    units = 1
...
f = open('results_bohai_test_compare_30.txt', 'a')
save_folder = 'saved_model_bohai_test_compare_30'
